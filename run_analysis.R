...
x_train<- read.table("/Users/deepikakulkarni/Documents/RCourse/GettingCleaning/UCI HAR Dataset/train/X_train.txt")
y_train<- read.table("/Users/deepikakulkarni/Documents/RCourse/GettingCleaning/UCI HAR Dataset/train/y_train.txt")
subject_train<- read.table("/Users/deepikakulkarni/Documents/RCourse/GettingCleaning/UCI HAR Dataset/train/subject_train.txt")
x_test<- read.table("/Users/deepikakulkarni/Documents/RCourse/GettingCleaning/UCI HAR Dataset/test/X_test.txt")
y_test<- read.table ("/Users/deepikakulkarni/Documents/RCourse/GettingCleaning/UCI HAR Dataset/test/y_test.txt")
subject_test<-read.table("/Users/deepikakulkarni/Documents/RCourse/GettingCleaning/UCI HAR Dataset/test/subject_test.txt")
...
features<- read.table("/Users/deepikakulkarni/Documents/RCourse/GettingCleaning/UCI HAR Dataset/features.txt")
...
act<-read.table("/Users/deepikakulkarni/Documents/RCourse/GettingCleaning/UCI HAR Dataset/activity_labels.txt")
...
write.table(all_data_mean,"/Users/deepikakulkarni/Documents/RCourse/GettingCleaning/tidydata.txt", row.names=FALSE)
